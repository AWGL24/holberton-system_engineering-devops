...
<p>At the end of this project, you are expected to be able to <a href="/rltoken/uzS14i1TrIOzP984RDR4-Q" title="explain to anyone" target="_blank">explain to anyone</a>, <strong>without the help of Google</strong>:</p>
